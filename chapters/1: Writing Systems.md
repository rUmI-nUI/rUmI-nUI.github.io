...
In this system, long vowels are marked using the acute accent. The circumflex still denotes nasalization. Sentence-initial letters are capitalized, and "ö" can be left in lowercase. Same as above, hyphens separate núíz and ní and can be used at the writer's discretion for emphasis.
